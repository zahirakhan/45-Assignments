...
let personName: string = "zahira khan";
console.log(
...
let famousQuote: string = "Lead with your actions, not just your words";
let author: string = "-Salahuddin Ayyubi";
...
let message: string = "Lead with your actions, not just your words.";
let famous_person: string = "-Salahuddin Ayyubi";
...
let names: string[] = ["Sara", "Georgia", "Zahira", "Harley"];
...
let names1: string[] = ["Sara", "Georgia", "Zahira", "Harley"];
for (let name of names1) {
  console.log(
    `Hello, ${name}!! would you like to have some coffe with me at my place?`
  );
}
...
let favoritetransport: string[] = ["Car", "Motorbike", "Plane"];
...
let dinnerinvitation: string[] = ["Sara", "Georgia", "Zahira", "Harley"];
dinnerinvitation.forEach((dinnerinvitation) => {
  console.log(
    `Dear ${dinnerinvitation}, would you like to join me for dinner?`
  );
});
...
let unAbletoAttend: string = "zaran";
console.log(`${unAbletoAttend}, can't come to the dinner`);
let newInvitee: string = "sarah";
...
console.log(
  `Book Info: ${book.Title} by ${book.Author} , Published in ${book.Year}`
);
...
let usernames: string[] = ["admin", "zara", "rida", "sidra", "John"];
...
let usernames2: string[] = []; // Empty user list
if (usernames2.length === 0) console.log("We need to find some users!");
else {
  usernames2 = [];
...
let current_users: string[] = ["zara", "sara", "ali", "admin"];
let new_users: string[] = ["zara", "admin", "zaini", "john", "sidra"];
...
let pizzas: string[] = ["pepperoni", "BBQ", "fajita"];
...
let animals: string[] = ["cat", "dogs", "rabbit"];
...
//The function should take in an artist name and an album title, and it should return a Object containing information.
...
let magician_names: string[] = ["zee", "zoe", "John", "Tom"];
...
let original_magician_names: string[] = [
  "sara",
  "maria",
  "georgie",
  "john",
...
let modified_magician_names: string[] = make_Great([
